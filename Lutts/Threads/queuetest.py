...
numconsumers = 2            #кол-во потоков потребителей
numproducers = 4            #кол-во потоков производителей
nummessages = 4             #кол-во сообщений, помещаемых производителем
...
if __name__ == '__main__':
    ...
    time.sleep(((numproducers-1) * numconsumers) + 1)
