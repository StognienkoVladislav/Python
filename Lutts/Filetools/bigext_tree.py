...
#-//- избегает загрузку содержимого файлов целиком
#пытается обойти проблемы, возникающие при выводе недекодируемых имен файлов/каталогов.
...
if len(argv) > 1: dirname = argv[1]     #например: E:\Python\Lib
...
for (title, key) in [('butes', 0), ('lines', 1)]:
    print('\nBy %s...' % title)
