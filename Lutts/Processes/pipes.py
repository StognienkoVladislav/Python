#соединяет свои потоки stdin/stdout с потоками stdout/stdin дочернего процесса

import os, sys

def spawn(prog, *args):      #имя программы, аргументы командной строки
    stdinFd = sys.stdin.fileno()            #получить дескриптор потоков
...
if __name__ == '__main__':
    ...
    """
    os.dup2(fd1, fd2)
        Копирует всю системную
        информацию, связанную с файлом, задан-
        ным дескриптором fd1, в файл, заданный дескриптором fd2.
"""